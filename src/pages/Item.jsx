...
const bids = ['$50,000', '$47,000'];
  function SimpleDialog(props) {
    ...
    return (
      <Dialog onClose={handleClose} open={open}>
        ...
        <DialogActions>
          <Button onClick={handleClose} style={{color:'black', padding:'7px', background:'#8585b9',
                                              border:'1px solid transparent', borderRadius:'15px'}}>Cancel</Button>
          <Button onClick={handleClose} style={{color:'black', padding:'7px', background:'#8585b9',
                                          border:'1px solid transparent', borderRadius:'15px'}}>Bid Now</Button>
        </DialogActions>
      </Dialog>
    );
  }
  ...
  return (
    ...
    <div style={{overflow:'hidden'}}>
      <NavBar />
      <Box mt={12}>
        <Grid container sx={{ height: "60px"}} style={{padding:'20px', marginBottom:'20px'}}>
          {/* <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}> */}
          <Grid item xs={12} md={6} >
            <img
              src={productDetail.image}
              alt="product"
              style={{ objectFit: "cover", width: "70%", border:'1px solid transparent', borderRadius:'20px', 
                       marginLeft:'20%' }}
            />
          </Grid>
          <Grid item xs={12} md={6} style={{borderLeft: '1px solid grey', padding:'20px'}}>
