    ...
    <Grid>
      <Paper elevation={10} style={paperStyle}>
       <Grid align='center'>
        ...
        <TextField label='Username'  placeholder='Enter username' variant='filled' style={txtstyle} fullWidth required /> 
        <TextField label='Password' placeholder='Enter password' variant='filled' style={txtstyle} type='password' fullWidth required/>
        <FormControlLabel control={<Checkbox defaultunChecked />} label="Remember Me" />      
        <Button type='submit' variant="contained" style={btmstyle} fullWidth >Sign in</Button>
        <Typography>
          <Link href='#' > 
            Forgot Password?
          </Link>
        ...
        <Link onClick={() => navigate("/SignUp")} > SignUp
      </Link>
        </Typography>
      </Paper>        
